    ...
    <div className="flex flex-col items-center p-4">
      ...
      <div className="flex flex-col gap-4 mb-6 w-full max-w-xl">
        <div className="flex gap-2">
          ...
          />
          <Button onClick={() => fetchWeather(zipInput)} className="bg-blue-600 hover:bg-blue-700">
            Search
          </Button>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          ...
          <Button onClick={handleSubscription} className="mt-3 w-full bg-green-600 hover:bg-green-700">
            Subscribe
          </Button>
        </div>
      </div>
      ...
      {selectedArea && (
        <Card className="mt-4 p-4 w-full max-w-lg bg-gray-900 text-white rounded-xl shadow-lg">
          ...
          <Button className="mt-4 bg-red-500 hover:bg-red-600 w-full">Get Alerts</Button>
        </Card>
      )}
    </div>
  );
